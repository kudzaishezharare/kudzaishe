...
export const seoByPath = {
  ...
  '/blogs': {
    ...
    description: 'Essays on African financial infrastructure, digital identity, agentic payments, and computation in local knowledge systems.'
  },
  '/article': {
    title: 'Recursive Architecture · Kudzaishe Zharare',
    description: 'Fractal geometry, recursion, and context-aware engineering in Ba-Ila settlement architecture.'
  },
  '/flexid': {
    title: 'Protocol for Insurable Identity · Kudzaishe Zharare',
